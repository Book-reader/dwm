...
#define BAT_NOW_FILE "/sys/class/power_supply/BAT1/charge_now"
#define BAT_FULL_FILE "/sys/class/power_supply/BAT1/charge_full"
#define BAT_STATUS_FILE "/sys/class/power_supply/BAT1/status"
